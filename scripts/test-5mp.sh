#!/bin/bash
# Test 2592x1944 (5MP native) resolution at 15fps

export GST_PLUGIN_PATH=/usr/local/lib/aarch64-linux-gnu/gstreamer-1.0

OUTPUT="/home/pi/Videos/test-5mp.mp4"
echo "Testing 2592x1944@15fps -> $OUTPUT"

timeout 2s gst-launch-1.0 libcamerasrc ! \
    "video/x-raw,format=RGB,width=2592,height=1944,framerate=15/1" ! \
    videoconvert ! \
